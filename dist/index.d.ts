...
export declare const macros: Map<any, any>;
export interface TsMacrosConfig {
    noComptime?: boolean;
}
declare const _default: (program: ts.Program, config?: TsMacrosConfig) => ts.TransformerFactory<ts.Node>;
 ...
 * ```
 */
export type Accumulator = number & {
    __marker?: "Accumulator";
};
/**
 ...
 * ```
 */
export type Save<T> = T & {
    __marker?: "Save";
};
export type EmptyDecorator = (...props: any) => void;
export declare const enum LabelKinds {
    If = 0,
    ForIter = 1,
    For = 2,
    While = 3,
